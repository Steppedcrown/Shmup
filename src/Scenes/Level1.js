...
export class Level1 extends BaseLevel {
  ...
  create() {
    ...
    this.createEnemy("basic", "ships", "shipYellow_manned.png", 0.4, 1, 100, this.shipExplosionSFX, 0, 100, 100, this.basicLaserSFX, 15, 1, 3, 1);
    this.createEnemy("heavy", "ships", "shipBeige_manned.png", 0.25, 4, 100, this.shipExplosionSFX, 1, 200, 100, this.basicLaserSFX, 10, 2, 2, 1);
